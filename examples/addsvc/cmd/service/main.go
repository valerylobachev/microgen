...
import (
	...
	service "github.com/valerylobachev/microgen/examples/addsvc/service"
	transport "github.com/valerylobachev/microgen/examples/addsvc/transport"
	grpc "github.com/valerylobachev/microgen/examples/addsvc/transport/grpc"
	http "github.com/valerylobachev/microgen/examples/addsvc/transport/http"
...
func main() {
	...
	var svc addsvc.Service                               // TODO: = service.NewService () // Create new service.
...
func ServeGRPC(ctx context.Context, endpoints *transport.EndpointsSet, addr string, logger log.Logger) error {
	...
	protobuf.RegisterServiceServer(grpcServer, server)
